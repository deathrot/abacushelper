...
{
    public class AvergaCylinderTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        {
            Logic.Engine.QuestionCylinders.AverageCylinder cylinder = new Logic.Engine.QuestionCylinders.AverageCylinder();
            var q = cylinder.Fire(1);

            NUnit.Framework.Assert.Greater(q.Calculate(), 0);
            NUnit.Framework.Assert.IsTrue(q.GetType() == typeof(Logic.Question.AvergaQuestion));
        ...
        {
            Logic.Engine.QuestionCylinders.AverageCylinder cylinder = 
                new Logic.Engine.QuestionCylinders.AverageCylinder();
