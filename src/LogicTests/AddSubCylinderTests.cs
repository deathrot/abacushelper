...
{
    public class AddSubCylinderTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        {
            Logic.Engine.QuestionCylinders.AddSubQuestionCylinder cylinder = new Logic.Engine.QuestionCylinders.AddSubQuestionCylinder();
            var q = cylinder.Fire(1);

            NUnit.Framework.Assert.Greater(q.Calculate(), 0);
            NUnit.Framework.Assert.IsTrue(q.GetType() == typeof(Logic.Question.AddSubQuestion));
        ...
        {
            Logic.Engine.QuestionCylinders.AddSubQuestionCylinder cylinder = 
                new Logic.Engine.QuestionCylinders.AddSubQuestionCylinder();
